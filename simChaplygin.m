...
tic
[z,F,INFO] = optimizeChaplygin(x_0, x_f, ind1, ind2,nx,nu,N,dt,params);
toc
...
figure, hold on
plot(t,z_states(:,1));  plot(t_cont, z_cont(:,1));
plot(t,z_states(:,2));  plot(t_cont, z_cont(:,2));
plot(t,z_states(:,3));  plot(t_cont, z_cont(:,3)); 
plot(t,z_states(:,4));  plot(t_cont, z_cont(:,4));
...
figure, hold on
plot(t,z_states(:,5));  plot(t_cont, z_cont(:,5));
plot(t,z_states(:,6));  plot(t_cont, z_cont(:,6));
plot(t,z_states(:,7));  plot(t_cont, z_cont(:,7));
plot(t,z_states(:,8));  plot(t_cont, z_cont(:,8));
...
figure, hold on
plot(t,z_controls); plot(params.Tapp(:,1),params.Tapp(:,2));
